...
* [Qt](https://qt.io/) :zap: - A cross-platform application and UI framework. [LGPL]
...
* [ALGLIB](http://www.alglib.net/) ALGLIB is a cross-platform numerical analysis and data processing library.
...
* [Qt Creator](http://qt-project.org/) :zap: - A cross-platform C++, JavaScript and QML IDE which is part of the SDK for Qt.
